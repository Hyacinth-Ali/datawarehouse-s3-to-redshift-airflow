...
#
    @task()
    def find_trips_under_18(*args, **kwargs):
    ...
    find_trips_task = find_trips_under_18()
    bike_frequency_task = bike_ridden_frequency()
    stations_task = count_number_of_stations()
