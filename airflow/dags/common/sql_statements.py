class SqlQueries:
    ...
    data_quality_checks = [
        {
            'name': 'Check staging songs table number of rows',
            'test_sql': 'SELECT COUNT(*) FROM staging_events_table',
            'expected_result': 0,
            'comparison': '>'
        },
        {
            'name': 'Check staging songs table number of rows',
            'test_sql': 'SELECT COUNT(*) FROM staging_songs_table',
            'expected_result': 0,
            'comparison': '>'
        },
        {
            'name': 'Check stating events number of rows',
            'test_sql': 'SELECT COUNT(*) FROM songplay_table',
            'expected_result': 0,
            'comparison': '>'
        },
        {
            'name': 'Check user table number of rows',
            'test_sql': 'SELECT COUNT(*) FROM user_table',
            'expected_result': 0,
            'comparison': '>'
        },
        {
            'name': 'Check artist table number of rows',
            'test_sql': 'SELECT COUNT(*) FROM artist_table',
            'expected_result': 0,
            'comparison': '>'
        },
        {
            'name': 'Check song table number of rows',
            'test_sql': 'SELECT COUNT(*) FROM song_table',
            'expected_result': 0,
            'comparison': '>'
        },
        {
            'name': 'Check time table number of rows',
            'test_sql': 'SELECT COUNT(*) FROM time_table',
            'name': 'Check stating songs number of rows',
            'expected_result': 0,
            'comparison': '>'
        }
    ]
